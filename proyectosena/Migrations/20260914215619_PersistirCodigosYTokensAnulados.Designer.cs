...
namespace proyectosena.Migrations
{
    ...
    [Migration("20260914215619_PersistirCodigosYTokensAnulados")]
    partial class PersistirCodigosYTokensAnulados
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("proyectosena.Models.RevokedToken", b =>
                {
            ...
            modelBuilder.Entity("proyectosena.Models.UserTokenRevocation", b =>
                {
                    b.Property<Guid>("IdUser")
                        .HasColumnType("uuid");

                    b.Property<DateTime>("RevokedBefore")
                        .HasColumnType("timestamp with time zone");

                    b.HasKey("IdUser");

                    b.ToTable("UserTokenRevocation", (string)null);
                });

            modelBuilder.Entity("proyectosena.Models.VerificationCode", b =>
                {
            ...
            modelBuilder.Entity("proyectosena.Models.UserTokenRevocation", b =>
                {
                    b.HasOne("proyectosena.Models.User", null)
                        .WithOne()
                        .HasForeignKey("proyectosena.Models.UserTokenRevocation", "IdUser")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
